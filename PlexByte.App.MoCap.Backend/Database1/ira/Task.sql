CREATE TABLE [ira].[Task] (
    ...
    [CreatedDateTime] DATETIME CONSTRAINT [DEF_Task_CreatedDateTime] DEFAULT GETDATE() NOT NULL,
    [ModifiedDateTime] DATETIME CONSTRAINT [DEF_Task_ModifiedDateTime] DEFAULT GETDATE() NOT NULL,
