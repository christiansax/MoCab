...
CREATE VIEW [dbo].[View_Task]
	AS 
	SELECT	[t].[Id], [t].[Title], [i].[Text] AS TaskDescription, [t].[InteractionId], [i].[StartDateTime], [i].[EndDateTime], [t].[DueDateTime], [i].[StateId], [s].[Text] AS StateName, [i].[IsActive], [t].[Priority], 
