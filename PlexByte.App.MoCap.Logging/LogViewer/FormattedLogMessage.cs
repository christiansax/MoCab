        ...
        public FormattedLogMessage(LogMessage pLogMessage, string pIndentSpacer)
        {
            ...
            switch (pLogMessage.Type)
            {
                case MessageType.EnterScope:
                    Type = Properties.Resources.EnterScope.ToBitmap();
                    break;
                case MessageType.ExitScope:
                    Type = Properties.Resources.ExitScope.ToBitmap();
                    break;
                case MessageType.Detail:
                    Type = Properties.Resources.Detail.ToBitmap();
                    break;
                case MessageType.Error:
                    Type = Properties.Resources.Error.ToBitmap();
                    break;
                case MessageType.Warning:
                    Type = Properties.Resources.Warning.ToBitmap();
                    break;
                case MessageType.Info:
                    Type = Properties.Resources.Info.ToBitmap();
                    break;
                default:
                    Type = Properties.Resources.All.ToBitmap();
                    break;
            }
