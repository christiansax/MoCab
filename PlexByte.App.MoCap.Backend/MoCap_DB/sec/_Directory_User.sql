CREATE TABLE [sec].[_Directory_User]
(
...
CREATE INDEX [IX__Directory_User_DirectoryId] ON [sec].[_Directory_User] ([DirectoryId])

GO

CREATE INDEX [IX__Directory_User_UserId] ON [sec].[_Directory_User] ([UserId])

GO

CREATE INDEX [IX__Directory_User_ProjectId] ON [sec].[_Directory_User] ([ProjectId])
